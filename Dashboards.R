...
CAPs_pivot <- read_excel("C:/Users/Andrew/Box Sync/Dashboards/Dashboard Workbook/Remediation Workbook.xlsx", 1, skip = 3)
...
CAPs_RVVs <- read_excel("C:/Users/Andrew/Box Sync/Dashboards/Dashboard Workbook/Remediation Workbook.xlsx", 2, skip = 1)
RVV1 = CAPs_RVVs[,1:5]
...
#### Master Factory List ####
Master <- read_excel("C:/Users/Andrew/Box Sync/Dashboards/Dashboard Workbook/MASTER Factory Status_ 2016-March-31- 5PM_Lj.xlsx", "Master Factory List")
...
Master[, c("Working Comments", "Factory Closed", "Factory Closure Reason", "Date Added to FFC (Activated as Pending)", "Deactivated brands (Date)", "Building Expanded? \r\n(if yes, list date)", "Date Approved (for factories added after April 2015)", "Thermal Scan Report Sending Date", "Linked Factories Building", "Linked Factories Compound",
           "Not on Case Manager List (JW)", "Case Team Number", "QAF", "Worker Compensation Required?", "FOS Status (OK, DEA Needed, Core Test Needed, Review Panel)", "DEA / Core Test Status (Not Started, In Progress, Completed)", "FOS Status (OK, DEA Needed, Core Test Needed, Review Panel) [Second Round Review]", "Access Denied?", "Tentative Date of 1st RVV", "1st RVV Done?", 
...
#### Plan Review Tracker ####
PR <- read_excel("C:/Users/Andrew/Box Sync/Dashboards/Dashboard Workbook/Master Tracker.xls", "Master Tracker", skip = 1)
...
SG_Training <- read_excel("C:/Users/Andrew/Box Sync/Dashboards/Dashboard Workbook/Security Guard Training Implementation_Mar 31 16_Imran.xlsx", 1)
...
#### Helpline ####
## Helpline calls ##
H_calls <- read_excel("C:/Users/Andrew/Box Sync/Dashboards/Dashboard Workbook/Amader Kotha - Dec1.14 - Feb29.16 (Alliance).xlsx", 2, skip = 1)
...
#### Dashboard Workbook ####
Combined <- read_excel("C:/Users/Andrew/Box Sync/Dashboards/Dashboard Workbook/Dashboard Workbook.xlsm", "Combined", skip = 2)

Factory_Monthly <- read_excel("C:/Users/Andrew/Box Sync/Dashboards/Dashboard Workbook/Dashboard Workbook.xlsm", "Factory Monthly", skip = 1)
