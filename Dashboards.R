...
# Set names if including "no level" Accord CAPs
...
#### Master Factory List ####
Master <- read_excel("C:/Users/Andrew/Dropbox (AFBWS.org)/Member Dashboards/Dashboard Workbook/MASTER Factory Status_ 2016-Feb- 25_lj.xlsx", "Master Factory List")
Master = Master[complete.cases(Master$`Account ID`),]

## Suspended Factories ##
#Suspended <- read_excel("C:/Users/Andrew/Dropbox (AFBWS.org)/Member Dashboards/Dashboard Workbook/MASTER Factory Status_ 2016-Feb- 25_lj.xlsx", 2)
...
#### Plan Review Tracker ####
PR <- read_excel("C:/Users/Andrew/Dropbox (AFBWS.org)/Member Dashboards/Dashboard Workbook/Master Tracker.xls", "Master Tracker", skip = 1)
...
Training <- read_excel("C:/Users/Andrew/Dropbox (AFBWS.org)/Member Dashboards/Dashboard Workbook/Training Implementation_Feb 25 16_Imran.xlsx", 1)
...
SG_Training <- read_excel("C:/Users/Andrew/Dropbox (AFBWS.org)/Member Dashboards/Dashboard Workbook/Security Guard Training Implementation_Feb 25 16_Imran.xlsx", 1)
...
#### Helpline ####
## Helpline calls ##
H_calls <- read_excel("C:/Users/Andrew/Dropbox (AFBWS.org)/Member Dashboards/Dashboard Workbook/Amader Kotha - Dec1.14 - Jan31.16 (Alliance).xlsx", 2, skip = 1)
...
Factory_Monthly <- read_excel("C:/Users/Andrew/Dropbox (AFBWS.org)/Member Dashboards/Dashboard Workbook/Dashboard Workbook.xlsm", "Factory Monthly", skip = 1)
