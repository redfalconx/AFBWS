...
file.rename(paste(wd,"/Documents/", Afile, sep = ""), paste(wd,"/Documents/Expansions.xls", sep = ""))
Expansions <- as.data.frame(readHTMLTable(paste(wd,"/Documents/Expansions.xls", sep = "")))
Sys.sleep(5)
